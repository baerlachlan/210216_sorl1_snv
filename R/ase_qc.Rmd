...
```{r}
files <- list.files(
  "/hpcfs/users/a1647910/210216_sorl1_snv/05_addRG/samstats",
  full.names = TRUE
)
...
```{r}
files <- list.files(
  "/hpcfs/users/a1647910/210216_sorl1_snv/07_recalBases/samstats",
  full.names = TRUE
)
...
```{r}
intervalPath <- "/hpcfs/users/a1647910/210216_sorl1_snv/refs/exons.intervals"
...
```{r}
bedPath <- "/hpcfs/users/a1647910/210216_sorl1_snv/refs/exons.bed"
