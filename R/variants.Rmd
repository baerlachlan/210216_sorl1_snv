...
if (!file.exists(allele_dist_path)) {
  allele_dist <- lapply(
    list(
      allele_props[c("V1482Afs_het", "WT")],
      allele_props[c("R122Pfs_het", "WT")],
      allele_props[c("Trans", "WT")]
    ),
    function(props){
    ...
    set_names(c("V1482Afs_het", "R122Pfs_het", "Trans"))
...
plot_allele_dist(
  ...
  mutation = genes[genes$gene_name == "sorl1"],
